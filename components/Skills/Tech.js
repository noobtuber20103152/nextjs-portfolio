                    ...
                    <li class="mb-10 ml-6">
                        ...
                        <div class="p-4 bg-white rounded-lg border border-gray-200 shadow-sm dark:bg-gray-700 dark:border-gray-600">
                            <div class="justify-between items-center mb-3 sm:flex">
                                ...
                                <div class="text-sm font-normal text-gray-500 lex dark:text-gray-300">Tech stack and programming languages which I use to make web application.<a href="#" class="font-semibold text-gray-900 dark:text-white hover:underline"></a></div>
                            </div>
