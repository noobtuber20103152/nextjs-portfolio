            ...
            <div className="pb-10">
                ...
                <div className="flex my-5 justify-center animate-fadeIn">
                    <div className='md:w-12/12 w-12/12 flex flex-wrap justify-center'>
                        ...
                        <a href="https://youtube.com/@explorewithme100" target="_blank" rel="noreferrer" className="hover:shadow-lg hover:-translate-y-1 hover:shadow-red-500/50 bg-transparent mx-2 my-2 text-lg font-semibold border hover:border-gray-900 border-gray-400 duration-500 py-3 px-4   rounded">YouTube <BsYoutube className='inline text-2xl text-red-400' /> </a>
                    </div>
                </div>
                <div className='flex justify-center h-auto'>
                    <iframe className='w-full md:w-6/12 md:h-auto h-[30vh] md:mx-0 mx-2 text-white' src="https://github.com/sponsors/noobtuber20103152/card" title="Sponsor noobtuber20103152" ></iframe>
                </div>
            </div>
            <Codeeditor />
        </div>
