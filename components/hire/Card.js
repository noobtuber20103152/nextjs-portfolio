    ...
    return <>
        <div className='flex justify-center relative -my-52 items-center  '>
            <div className='md:w-10/12 w-11/12 bg-[#fffffe] rounded-lg shadow-2xl border-gray-400 border shadow-cyan-500/10 h-auto'>
                ...
                <p className='text-center text-xl font-semibold mt-5 text-[#83848b]' >Give me a chance I prove you, Why I am better than other.</p>
                <div className="flex my-5 justify-center animate-fadeIn">
                    <div className='md:w-12/12 w-12/12 flex flex-wrap justify-center'>
                        <a href="https://github.com/noobtuber20103152" target="_blank" rel="noreferrer" className="hover:shadow-lg hover:-translate-y-1 hover:shadow-cyan-500/50  bg-transparent mx-2 my-2  font-bold text-lg py-3 duration-500 hover:bg-[#2d2546]  bg-[#373b3f] text-white px-4 rounded">Explore <BsGithub className='inline text-2xl' /></a>
                        <a href="https://drive.google.com/file/d/1gN1sGdgugemsHe6mtzKFKhlAyMa85Lrs/view?usp=sharing" target="_blank" rel="noreferrer" className="hover:shadow-lg hover:-translate-y-1 hover:shadow-yellow-500/50 bg-transparent mx-2 my-2 text-lg font-semibold border hover:border-gray-900 border-gray-400 duration-500 py-3 px-4   rounded">Resume <AiFillFilePdf className='inline text-2xl' /> </a>
                    </div>
                </div>
                <div className="flex my-5  justify-center animate-fadeIn ">
                    <div className='md:w-12/12 w-12/12 flex flex-wrap  justify-center'>
                        <a href="https://www.codechef.com/users/ujjawal_100" target="_blank" rel="noreferrer" className="hover:shadow-lg hover:-translate-y-1 hover:shadow-cyan-500/50  bg-transparent mx-2 my-2  font-semibold text-lg py-3 duration-500  text-black px-4 rounded">Codechef <SiCodechef className='inline text-2xl' /></a>
                        <a href="https://leetcode.com/noobtuber/" target="_blank" rel="noreferrer" className="hover:shadow-lg hover:-translate-y-1 hover:shadow-red-500/50 bg-transparent mx-2 my-2 text-lg font-semibold  duration-500 py-3 px-4   rounded">Leetcode <SiLeetcode className='inline text-2xl' /> </a>
                        <a href="https://auth.geeksforgeeks.org/user/ujjawalrcs20" target="_blank" rel="noreferrer" className="hover:shadow-lg hover:-translate-y-1 hover:shadow-green-500/50 bg-transparent mx-2 my-2 text-lg font-semibold  duration-500 py-3 px-4   rounded">Geeksforgeek <SiGeeksforgeeks className='inline text-2xl' /> </a>
