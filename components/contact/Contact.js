                    ...
                    <div class="-mx-4 flex flex-wrap lg:justify-between">
                        <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                            <div class="mb-12 max-w-[570px] lg:mb-0">
                                ...
                                <div class="mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div class="w-full">
                                        <h4 class="text-dark mb-1 text-xl font-bold">Current Address</h4>
                                ...
                                <div class="mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <p class="text-body-color text-base">+918890881464</p>
                                    </div>
                                </div>
                                <div class="mb-8 flex w-full max-w-[370px]">
                                    <div class="bg-primary text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]" >
                                    ...
                                    <div class="w-full">
                                        ...
                                        <p class="text-body-color text-base">jobsujjawal100@gmail.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                            <div class="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                                <div>
                                    <div class="mb-6">
                                        <input value={data.name} onChange={onchange} name="name" type="text" placeholder="Your Name" class="text-body-color border-[f0f0f0] focus:border-primary w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                                        />
                                    </div>
                                    <div class="mb-6">
                                        <input value={data.email} onChange={onchange} name="email"
                                            type="email"
                                    ...
                                    <div class="mb-6">
                                        <input value={data.phone} onChange={onchange} name="phone"
                                            type="number"
                                    ...
                                    <div class="mb-6">
                                        <textarea value={data.message} onChange={onchange} name="message"
                                            rows="6"
                                    ...
                                    <div>
                                        {!sending && <button onClick={submit} type="submit" class={`${message == 'Send Message' ? 'bg-blue-700' : 'bg-green-700'} border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90`} >
                                            {message}
                                        </button >}
                                        {sending && <div className='flex justify-center items-center bg-primary border-primary w-full rounded border p-3 text-black transition hover:bg-opacity-90'> Sending <AiOutlineLoading3Quarters className='mx-2 animate-spin' /> </div>}
                                    </div>
                                </div>
                                <div>
