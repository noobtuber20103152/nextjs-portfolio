    ...
    return (
        <>
            <div className=' bg-transparent bg-[#25282f]   duration-1000 py-5 pl-5 pr-2'>
                ...
                {output && <div  >
                    <a href="https://www.codechef.com/users/ujjawal_100" target="_blank" className='py-2 mx-2 inline-block'>
                        <SiCodechef className='text-white text-2xl' />
                    </a>
                    <a href="https://leetcode.com/ujjawalrachhoya100/" target="_blank" className='py-2 mx-2 inline-block'>
                        <SiLeetcode className='text-red-500 text-2xl' />
                    </a>
                    <a href="https://codeforces.com/profile/Noob_tuber" target="_blank" className='py-2 mx-2 inline-block'>
                        <SiCodeforces className='text-blue-500 text-2xl' />
                    </a>
                    <a href="https://auth.geeksforgeeks.org/user/ujjawalrcs20/practice/" target="_blank" className='py-2 mx-2 inline-block'>
                        <SiGeeksforgeeks className='text-green-500 text-2xl' />
                    </a>
                    <a href="https://github.com/noobtuber20103152" target="_blank" className='py-2 mx-2 inline-block'>
