            ...
            <div className='bg-[#1b1f24] py-20'>
                ...
                <div className='w-12/12 my-5 ml-0 flex justify-center items-center'>
                    <div className=' w-12/12 md:w-4/12 '>
                        <button class="hover:shadow-lg hover:-translate-y-1 hover:shadow-cyan-500/50 bg-[#24292f] flex flex-col justify-center items-center font-semibold m-2  p-6 bordr rounded-xl">
